...
envs.hand["cfg"] = function(args)
	return envs.loadfile(envs.device, "zorya-cfg/zorya-cfg.lua")(envs, args)
end
...
if (not fs.exists("zorya-cfg/.zoryarc")) then
	envs.boot[#envs.boot+1] = {"Update Zorya and Init Modules", "netboot", "https://raw.githubusercontent.com/Adorable-Catgirl/Zorya-BIOS/master/update/init.lua", {}}
